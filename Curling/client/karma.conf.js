module.exports = function(config) {
    ...
    var effectsAssets = '/base/assets/effects/'; // Where our fonts will be located (karma proxy)
    ...
    config.set({
        ...
        files: [
            ...
            { pattern: assetsBase + 'models/*.dae', watched: false, included: false, served: true },
            ...
            { pattern: assetsBase + 'effects/*.*', watched: false, included: false, served: true },
